<style lang="css" src="assets/css/header.css" scoped></style>
<template>
	<div class="mall">
		<div class="first">
			<div class="container">
				...
				<form id="search">
					<ul class="nav Wline">
						<li>
							<label @click="showSlide"  class="head-label" v-text="curSrh"></label>
							<span class="placeicon"></span>
							<ul class="nav buisnessDown" v-if='hide'>
								<li v-for="item in items" @click="hideSlide(item)">{{item}}</li>
							</ul>
						</li>
					</ul>
		...
		<div class="third">
			<div class="container">
				<ul class="nav">
					...
					<router-link class="firmInf" :to="{path:'/product',query:{routeCategroy:'aa'}}" tag="li" exact>商家</router-link>
				</ul>
			</div>
		</div>
	</div>
