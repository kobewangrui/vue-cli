    ...
    data(){
        return{
            ...
            "questionList":[
                    ...
                    {
                        "tit":"绑定交易账户",
                        "ctt":"<p>供应商需绑定收款账户。请至少绑定一个个人账户及一个对公账户。 可绑定多个账户，但只有默认收款账户可接收款项。请谨慎操作。</p><p>第一步：在财务管理－交易账户，点击添加账户。</p><img src='/resource/image/help/image074.png'><p>第二步：按照添加账户页面要求填写信息。请仔细核对信息和选择账户类型。</p><img src='/resource/image/help/image075.png'><p>第三步：确认。默认第一个账户为收款账户，如需调整请按当前提示操作。</p>"
                    },
                    {
                        "tit":"如何查看交易明细",
                        "ctt":"<p>在财务管理－交易明细中可查看详细的交易记录。</p><img src='/resource/image/help/image076.png'>"
                    },
                    {
                        "tit":"关于交易退款",
